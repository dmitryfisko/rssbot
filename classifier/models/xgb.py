...
from constants import POSTS_FILE_PATH, CATEGORIES, XGBOOST_PICKLE_CLF, XGBOOST_PICKLE_VECTORIZER
import numpy as np
import pickle
...
def main():
    ...
    clf = XgbClassifier(eta=0.09, min_child_weight=6, depth=20, num_round=200, threads=4)
    eval_predicts = clf.train_predict(train_features, train_labels, eval_features)
    print(eval_predicts)
